...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/old-resonance-35e5#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-resonance-35e5
```

A live public deployment of this template is available at [https://old-resonance-35e5.templates.workers.dev](https://old-resonance-35e5.templates.workers.dev)
